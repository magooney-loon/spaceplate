...
| `input`          | `inputState`                                                              | `defineInputMap`, `useInputMap`, `inputActions`                    | none (runtime only)                                       | [input/](input/CLAUDE.md)                   |
| `logger`         | `loggerState`                                                             | `loggerActions.toggleChannel(ch)`                                  | `LoggerExtension.svelte` ✅                               | [logger/](logger/CLAUDE.md)                 |
| `audio`          | — (the mixer, registry and positional fallbacks live in `core/audio/`)    | — (drive `audioActions` there / `settingsState.audio`)             | `AudioExtension.svelte` ✅ buses + positional + inspector | [audio/](audio/CLAUDE.md)                   |
