...
<div transition:fly={{ y: -16, duration: 220 }} style="position: absolute; inset: 0; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,0.6); backdrop-filter: blur(8px);">
		...
		<div style="margin-bottom: 1.5rem;">
			...
			<div style="display: flex; flex-direction: column; gap: 0.75rem;">
				<div style="display: flex; flex-direction: column; gap: 0.25rem;">
					...
					<input type="range" min="0" max="1" step="0.01" aria-label="Music volume"
				...
				<div style="display: flex; flex-direction: column; gap: 0.25rem;">
					...
					<input type="range" min="0" max="1" step="0.01" aria-label="Ambience volume"
				...
				<div style="display: flex; flex-direction: column; gap: 0.25rem;">
					...
					<input type="range" min="0" max="1" step="0.01" aria-label="Effects volume"
