<script lang="ts">
	...
	useTask(
		() => {
			...
			uFogCameraFar.value = far;
			// The BASE colour, flash included and inscatter excluded -- see the note on the
			// uniform for why the effect takes the flat one.
